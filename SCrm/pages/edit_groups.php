...
$this_page = plugin_page('edit_groups');
$this_page_create = plugin_page('edit_group_record') . '&action=create';
$this_page_edit = plugin_page('edit_group_record') . '&action=edit';
	...
	<div class="widget-box widget-color-blue2">
		...
		<div class="widget-header widget-header-small">
			<h4 class="widget-title lighter">
				...
				<?php echo plugin_lang_get('main_menu_groups');?>	
				<span class="badge"><?php echo plugin_lang_get('global_cmd_total') . ":" .  $resStat['group_count'];?></span>
			</h4>
		</div>
								...
								<?php 
									if (access_has_global_level(config_get(SCrmPlugin::CFG_KEY_MANAGE_TABLES_TRESHOLD)))
									{
										echo "<a class=\"btn btn-primary btn-white btn-round btn-sm\" href=\"{$this_page_create}\">";
											echo plugin_lang_get('edit_groups_page_cmd_add_group');
					...
					<thead>
						...
						<tbody>
							<?php 
								...
								$page_callback_link_url = plugin_page('edit_groups',true) .urlencode( 
								...
								while( $row = db_fetch_array( $list_query ) ) 
								{
									...
									echo "<tr>" .
										...
										"<td> {$row_link}" . $row['group_name'] . "</a></td>" .
