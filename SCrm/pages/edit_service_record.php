...
else if ($submit_save != '')
{
	...
	$field_service_name = gpc_get_string('field_service_name');
...
$record = DAOService::get_record($field_id);
		...
		<div class="widget-box widget-color-blue2">
			<div class="widget-header widget-header-small">
				<h4 class="widget-title lighter">
					<i class="fa fa-cog ace-icon"></i><?php echo plugin_lang_get('edit_service_record_label_edit_service')?>
						...
						<table class="table table-bordered table-condensed">
							<tbody>
								<tr>
									...
									<td>
										<input type="text" id="field_service_name" name="field_service_name" maxlength="128" style="width:100%;" value="<?php echo $field_service_name;?>" required>
									</td>
								</tr>
								...
								<tr>
									...
									<td>
										<input type="checkbox" id="field_is_billable" class="ace input-sm" name="field_is_billable" value="checked" <?php if ($field_is_billable=='checked') echo 'checked'; ?>><span class="lbl"></span>
									</td>
								</tr>
